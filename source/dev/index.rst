...
The rest of this manual describes how to set up Maven and other required tools for building and developing Spoofax, how to build and develop Spoofax, how to contribute changes, and explains some of the internals of Spoofax components.
...
You can either install this from an update site as listed in :ref:`the downloads section <all-downloads>`,
