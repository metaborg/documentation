...
# -*- coding: utf-8 -*-
#
# Spoofax documentation build configuration file, created by
# sphinx-quickstart on Fri Feb 26 13:22:04 2016.
#
...
exclude_patterns = ['_build', 'notes', 'code', 'include', 'README.md']
...
man_pages = [
    (master_doc, 'spoofax', 'Spoofax Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'Spoofax', 'Spoofax Documentation',
     author, 'Spoofax', 'One line description of project.',
     'Miscellaneous'),
]
